...
const NavBar = () => {
  ...
  return (
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative">
      ...
      {isOpen ? (
        <div className="min-w-[70vw] flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2  z-30 -translate-y-1/2 bg-dark/90 dark:bg-light/60 rounded-lg  py-32  backdrop-blur-md ">
          <nav className="flex items-center justify-center flex-colw">
            <CustomMobileLink
              href="/"
              title="Home"
              className="mr-4"
